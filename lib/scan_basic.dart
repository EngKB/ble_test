...
class ScanBasic extends StatefulWidget {
  const ScanBasic({Key? key}) : super(key: key);

  @override
  _ScanBasicState createState() => _ScanBasicState();
}

class _ScanBasicState extends State<ScanBasic> {
  ...
  Future<void> initBluetooth() async {
    bluetoothManager.startScan(timeout: Duration(seconds: 20));
